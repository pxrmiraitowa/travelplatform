package com.travelplatform.product.service.hotel.impl;
...
import com.travelplatform.product.vo.hotel.HotelRoomVO;
...
public class HotelServiceImpl implements HotelService {
    ...
    public PageResult<HotelListItemVO> searchHotels(HotelQueryRequest request) {
        HotelQueryRequest query = request == null ? new HotelQueryRequest() : request;
        ...
        List<Hotel> hotels = hotelMapper.selectList(new LambdaQueryWrapper<Hotel>()
                ...
                .like(StringUtils.hasText(query.getCity()), Hotel::getCity, query.getCity())
